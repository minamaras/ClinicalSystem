...
public class DoctorDTO {
    ...
    public DoctorDTO(Long id, String name, String lastname, String email, String password, Role role, String specialization, Time start, Time end, boolean firstLogin) {
        Id = id;
        this.name = name;
